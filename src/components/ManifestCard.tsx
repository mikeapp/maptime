    ...
    return (
        <Card raised={true}>
            ...
            <CardContent>
                    ...
                    {(manifest.navDateYear()) ?
                        <div>
                            ...
                            <Typography variant="caption" display="inline"
                                        gutterBottom>{manifest.navDateYear()}</Typography>
                        </div>
                        :
                        <div>
                ...
                <Box sx={{clear: "left"}}>
                    {(manifest.navPlace()) ? <MapIcon color={isSelected ? "primary" : "inherit"}/> :
                        <MapIcon color="disabled" sx={{opacity: '50%'}}/>}
                    <IconButton sx={{float: "right"}} size="small"
                                onClick={() => onShowInViewer ? onShowInViewer(manifest) : null}><ZoomInIcon/></IconButton>
                </Box>
            </CardContent>
        </Card>)
};
